...
public class CangkuxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		cangkuxinxi.setClicknum(cangkuxinxi.getClicknum()+1);
		cangkuxinxi.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,CangkuxinxiEntity cangkuxinxi, HttpServletRequest request,String pre){
        EntityWrapper<CangkuxinxiEntity> ew = new EntityWrapper<CangkuxinxiEntity>();
