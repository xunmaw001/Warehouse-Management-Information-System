<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="货物编号" prop="huowubianhao">
          <el-input v-model="ruleForm.huowubianhao" 
              placeholder="货物编号" clearable  :readonly="ro.huowubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="货物编号" prop="huowubianhao">
              <el-input v-model="ruleForm.huowubianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="客户" prop="kehu">
          <el-select :disabled="ro.kehu" v-model="ruleForm.kehu" placeholder="请选择客户">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="客户" prop="kehu">
	      <el-input v-model="ruleForm.kehu"
                placeholder="客户" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huowuchuku/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huowuchukuCrossAddOrUpdateFlag = false;
						 this.parent.search();
