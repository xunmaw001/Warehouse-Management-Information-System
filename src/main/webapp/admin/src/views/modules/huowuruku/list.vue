  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="供应商" prop="gongyingshang">
	    ...
	    <download-excel v-if="isAuth('huowuruku','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "货物入库.xls">
		      <!-- 导出excel -->
            	<el-button
  ...
  methods: {
    ...
    chartDialog() {
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            url: `huowuruku/value/huowumingcheng/shuliang`,
            method: "get"
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
